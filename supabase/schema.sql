...
('les-classroom-vocab-1', 4.7, 'Unit 1: Hangul & Korean Basics', 'Classroom Vocab (교실용어)', 'Essential classroom expressions, phrases, and commands in Korean.', 'custom', NULL, NULL, 'Active', '[
  ...
  {"id": "cr-2", "korean": "들으세요", "romanization": "deul-eu-se-yo", "english": "please listen", "category": "Commands"},
  {"id": "cr-3", "korean": "읽으세요", "romanization": "ilg-eu-se-yo", "english": "please read", "category": "Commands"},
  ...
  {"id": "cr-10", "korean": "친구에게 물어보세요", "romanization": "chin-gu-e-ge mul-eo-bo-se-yo", "english": "ask your friend", "category": "Commands"},
