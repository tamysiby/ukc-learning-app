...
[
  ...
  },
  {
    ...
    "order": 4.65,
    "unit": "Unit 1: Hangul & Korean Basics",
    "title": "N이/가 N예요/이에? · N은/는 N예요/이에요.",
    "description": "Learn Subject particles (이/가) and Topic particles (은/는) in Q&A sentence structures.",
    "type": "custom",
    "status": "Active",
    "words": [
  ...
  {
    "id": "les-occupations-1",
    "order": 17,
    "unit": "Unit 1: Hangul & Korean Basics",
    "title": "Occupations (직업)",
    "description": "Learn 18 essential Korean occupation and career vocabulary words with illustrated flashcards.",
    "type": "vocab",
    "paired_quiz_id": "les-occupations-quiz-1",
    "status": "Active",
    "words": [
  ...
  {
    "id": "les-occupations-quiz-1",
    "order": 18,
    "unit": "Unit 1: Hangul & Korean Basics",
    "title": "Occupations Quiz (직업 퀴즈)",
    "description": "Test your knowledge on Korean occupation and career vocabulary.",
    "type": "vocab quiz",
    "paired_vocab_id": "les-occupations-1",
    "status": "Active"
  }
]
```
